try {
  let update = false;
  if (window.SOCIALBROWSER && SOCIALBROWSER.var && SOCIALBROWSER.var.blocking) {
    if (SOCIALBROWSER.var.blocking.white_list) {
    ...
    if (SOCIALBROWSER.var.blocking.popup && SOCIALBROWSER.var.blocking.popup.white_list) {
