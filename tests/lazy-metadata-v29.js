...
assert.equal(pkg.version, '2026.08.26-v29');
...
assert.deepEqual(site.requireFromString('module.exports = {ok:true}', path.join(process.cwd(),'v29-inline.js')), {ok:true});
console.log('PASS v29 package/module metadata remains API-compatible and lazy until first use');
