...
function setOptions(options , site) {
  ...
  setInterval(() => {
    ...
    console.log('System UpTime ... ' + ((currentDate.getTime() - startedDate.getTime()) / 1000 / 60) + ' Minute' )
  ...
  setInterval(() => {
    let currentDate = new Date()
    console.log('Site UpTime ... ' + ((currentDate.getTime() - startedDate.getTime()) / 1000 / 60) + ' Minute' )
    }, 1000 * 60 * 1)
}
