...
function setOptions(options, site) {
  ...
  if (!options.full) {
    ...
    setInterval(() => {
      ...
      let msg = ' !! Site Uptime ::::  ' + ((currentDate.getTime() - site.startedDate.getTime()) / 1000 / 60).toFixed(2).toString() + ' Minute  !!  '
    ...
    setInterval(() => {
      ...
      let currentDate = new Date()
      console.log('')
      console.log('  Site Uptime ::  ' + ((currentDate.getTime() - site.startedDate.getTime()) / 1000 / 60).toFixed(2) + ' Minute')
      console.log('')
