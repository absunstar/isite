...
function setOptions(_options, site) {
  ...
  AllOptions.session.db = AllOptions.session.db || template.mongodb.db
  ...
  AllOptions.security.db = AllOptions.security.db || template.mongodb.db
  ...
  if (!options.full) {
    ...
    setInterval(() => {
      ...
      let msg = ' !! ' + AllOptions.name + ' Uptime ::::  ' + ((currentDate.getTime() - site.startedDate.getTime()) / 1000 / 60).toFixed(2).toString() + ' Minute  !!  '
    ...
    setInterval(() => {
      ...
      let currentDate = new Date()
      console.log('')
      console.log(' !! ' + AllOptions.name + '  Uptime ::  ' + ((currentDate.getTime() - site.startedDate.getTime()) / 1000 / 60).toFixed(2) + ' Minute')
      console.log('')
