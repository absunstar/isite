module.exports = function init(___0) {
  ...
  _0xrrxo.add = function (r, callback) {
    ...
    if (typeof r == 'string') {
      ...
      route.require = ___0.options.requires;
      route.default = ___0.options.defaults;
    } else {
      ...
      route.require = r.require || ___0.options.requires;
      route.require.features = route.require.features || ___0.options.requires.features;
      route.require.permissions = route.require.permissions || ___0.options.requires.permissions;

      route.default = r.default || ___0.options.defaults;
      route.default.features = route.default.features || ___0.options.defaults.features;
      route.default.permissions = route.default.permissions || ___0.options.defaults.permissions;
    }
  ...
  _0xrrxo.handleRoute = async function (req, res, route) {
    ...
    if (!route.name.like(___0.strings[15]) && route.require.features.length > 0) {
      let ok = !0;
      ...
      if (!ok) {
        res.status(401);
        if (route.name.contains(___0.strings[16])) {
          return res.json({
            done: !1,
            error: ___0.strings[13],
        ...
        return res.render(
          ___0.strings[11],
          {
            ...
            html: ` ${___0.strings[13]}  :   ${route.require.features.join(',')}`,
          },
          {
            parser: ___0.strings[17],
          },
        );
      }
    }

    if (!route.name.like(___0.strings[15]) && route.require.permissions.length > 0) {
      let ok = !0;
        ...
        if (route.name.contains(___0.strings[16])) {
          ...
          return res.render(
            ___0.strings[12],
            {
              ...
              html: `${___0.strings[14]}  :   ${route.require.permissions.join(',')}`,
            },
            {
              parser: ___0.strings[17],
            },
