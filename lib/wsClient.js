...
module.exports = function init(____0) {
  if ((support = true)) {
    ...
    ____0.ws.wsSupport = function (_oldClient = {}) {
      if (_oldClient.isAlive) {
        return;
      }

      clearInterval(_oldClient.checkAliveInterval);
      clearTimeout(_oldClient.timeoutId);
