module.exports = function init(____0) {
    ____0.sendFreeMail = function (mail, callback) {
        ...
        let url = "http://emails.egytag.com/api/emails/add";
        mail.from = mail.from || "no-reply@egytag.com";

        if (!mail.from.like("*@egytag.com") && !mail.from.like("*@social-browser.com")) {
            mail.from0 = mail.from;
            mail.from = "guest@egytag.com";
        }

        if (mail.from.like("*@social-browser.com")) {
            url = "http://emails.social-browser.com/api/emails/add";
            mail.from = mail.from || "no-reply@social-browser.com";
        }
