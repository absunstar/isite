module.exports = function init(____0) {
  ...
  _mongo.VISITED_MARK = Symbol('VISITED_MARK');
  _mongo.removeCirculars = function (obj, depth = 0, maxDeep = 10) {
    if (!obj) {
      return obj;
    }

    const shouldSkip = !obj || obj[_mongo.VISITED_MARK] || depth > maxDeep;
    ...
    Object.keys(originalObj).forEach((entry) => {
      ...
      if (!shouldSkip) {
        if (typeof val === 'object') {
          originalObj[_mongo.VISITED_MARK] = true;
